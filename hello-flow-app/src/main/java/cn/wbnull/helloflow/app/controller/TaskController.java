...
public class TaskController extends BaseController {
    ...
    public Result<TaskVO> createTask(@PathVariable Long projectId,
        ...
        return Result.success(hfTaskService.createTask(projectId, request, getCurrentUserId()));
    }
    ...
    public Result<TaskVO> updateTask(@PathVariable Long id, @RequestBody TaskUpdateRequest request) {
        return Result.success(hfTaskService.updateTask(id, request, getCurrentUserId()));
    }

    @DeleteMapping("/tasks/{id}")
    @Operation(summary = "删除任务")
    public Result<Void> deleteTask(@PathVariable Long id) {
        hfTaskService.deleteTask(id, getCurrentUserId());
        return Result.success();
    }

    @PostMapping("/tasks/{id}/assign")
    @Operation(summary = "分配任务")
    public Result<Void> assignTask(@PathVariable Long id, @RequestBody TaskAssignRequest request) {
        hfTaskService.assignTask(id, request, getCurrentUserId());
        return Result.success();
    }
    ...
    public Result<Void> startTask(@PathVariable Long id) {
        hfTaskService.startTask(id, getCurrentUserId());
        return Result.success();
    }
    ...
    public Result<Void> completeDev(@PathVariable Long id) {
        hfTaskService.completeDev(id, getCurrentUserId());
        return Result.success();
    }
    ...
    public Result<Void> reviewPass(@PathVariable Long id) {
        hfTaskService.reviewPass(id, getCurrentUserId());
        return Result.success();
    }
    ...
    public Result<Void> reviewReject(@PathVariable Long id) {
        hfTaskService.reviewReject(id, getCurrentUserId());
        return Result.success();
    }
    ...
    public Result<Void> testPass(@PathVariable Long id) {
        hfTaskService.testPass(id, getCurrentUserId());
        return Result.success();
    }
    ...
    public Result<Void> testReject(@PathVariable Long id) {
        hfTaskService.testReject(id, getCurrentUserId());
        return Result.success();
    }
    ...
    public Result<Void> reopenTask(@PathVariable Long id) {
        hfTaskService.reopenTask(id, getCurrentUserId());
        return Result.success();
    }
    ...
    public Result<Void> closeTask(@PathVariable Long id) {
        hfTaskService.closeTask(id, getCurrentUserId());
        return Result.success();
    }

    @PostMapping("/tasks/{id}/cancel")
    @Operation(summary = "取消任务")
    public Result<Void> cancelTask(@PathVariable Long id, @RequestBody TaskCancelRequest request) {
        hfTaskService.cancelTask(id, request, getCurrentUserId());
        return Result.success();
    }

    @PostMapping("/tasks/{id}/delay")
    @Operation(summary = "标记延期")
    public Result<Void> delayTask(@PathVariable Long id, @RequestBody TaskDelayRequest request) {
        hfTaskService.delayTask(id, request, getCurrentUserId());
        return Result.success();
    }
    ...
    public Result<TaskVO> createSubTask(@PathVariable Long id,
                                        @Valid @RequestBody TaskCreateRequest request) {
        return Result.success(hfTaskService.createSubTask(id, request, getCurrentUserId()));
    }
    ...
    public Result<Page<TaskVO>> listMyTasks(TaskCondition condition) {
        condition.setAssigneeId(getCurrentUserId());
    ...
    public Result<Page<TaskVO>> listReportedTasks(TaskCondition condition) {
        condition.setReporterId(getCurrentUserId());
    ...
    public Result<CommentVO> addComment(@PathVariable Long id,
        ...
        return Result.success(hfCommentService.addComment(id, request, getCurrentUserId()));
    }
